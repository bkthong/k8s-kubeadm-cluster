...
# Network information
network  --bootproto=static --device=eth0 --ip=192.168.122.212 --netmask=255.255.255.0 --gateway=192.168.122.1 --nameserver=192.168.122.1 --ipv6=auto --onboot=on
#network  --bootproto=dhcp --device=eth0 --onboot=off --ipv6=auto 
network  --hostname=worker02.lab.example.com
